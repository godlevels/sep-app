...
const Header = () => {
  ...
  return (
    <header className={`${isActive ? "h-[100px] lg:h-[110px] shadow-lg" : "h-[100px] lg:h-[150px]"} fixed bg-white left-0 top-0 z-10 max-w-[1920px] w-full mx-auto transition-all duration-300`}>
